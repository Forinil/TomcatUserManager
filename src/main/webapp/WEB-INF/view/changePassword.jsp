...
<div class="container">
    ...
    <page:navbar/>
    <form:form action="${spring:mvcUrl('UC#setPassword').arg(0, user.userName).build()}" cssClass="form-horizontal" modelAttribute="user">
        ...
        <page:submitButton text="Change password" />
    </form:form>
</body>
</html>
